...
var CONFIG = {
    ...
    indexHtmlTemplate: './src/safer.Client/public/index.html',
    fsharpEntry: './src/safer.Client/.fable-build/App.js',
    cssEntry: './src/safer.Client/styles/styles.scss',
    outputDir: './publish/app/public',
    assetsDir: './src/safer.Client/public',
    devServerPort: 8080,
